...
export const MOCK_FAVOURITES: ProductSuggestion[] = [
  {
    ...
    size: '4 pints',
    image: 'https://www.waitrose.com/product/images/duchy-organic-semi-skimmed-milk-4-pints',
    price: 2.85,
    unitPrice: '71p/litre',
    source: 'favourite',
  },
  {
    ...
    size: '24 pack',
    image: 'https://www.waitrose.com/product/images/weetabix-24-pack',
    price: 3.5,
    unitPrice: '15p each',
    source: 'favourite',
  },
  {
    ...
    size: '250g',
    image: 'https://www.waitrose.com/product/images/essential-salted-butter',
    price: 2.25,
    unitPrice: '£9.00/kg',
    source: 'favourite',
  },
...
export const MOCK_PREVIOUS_PURCHASES: ProductSuggestion[] = [
  {
    ...
    title: 'Duchy Organic Semi-Skimmed Milk',
    size: '1 pint',
    image: 'https://www.waitrose.com/product/images/duchy-organic-semi-skimmed-milk-1-pint',
    price: 1.15,
    unitPrice: '£1.15/pint',
  ...
  },
  {
    ...
    size: '4 pints',
    image: 'https://www.waitrose.com/product/images/duchy-organic-whole-milk-4-pints',
    price: 3.1,
    unitPrice: '77p/litre',
    source: 'previous-purchase',
  },
  {
    ...
    size: '1 litre',
    image: 'https://www.waitrose.com/product/images/no1-organic-ayrshire-milk',
    price: 1.85,
  ...
  },
  {
    ...
    size: '1 litre',
    image: 'https://www.waitrose.com/product/images/organic-oat-drink',
    price: 1.95,
  ...
  },
  {
    ...
    size: '800g',
    image: 'https://www.waitrose.com/product/images/hovis-soft-white-bread',
    price: 1.4,
    unitPrice: '£1.75/kg',
    source: 'previous-purchase',
  },
...
export const MOCK_CATALOGUE: ProductSuggestion[] = [
  {
    ...
    size: '2 litres',
    image: 'https://www.waitrose.com/product/images/essential-semi-skimmed-milk-2l',
    price: 1.45,
    unitPrice: '73p/litre',
    source: 'catalogue',
  },
  {
    ...
    size: '2 litres',
    image: 'https://www.waitrose.com/product/images/essential-whole-milk-2l',
    price: 1.45,
    unitPrice: '73p/litre',
    source: 'catalogue',
  },
  {
    ...
    size: '400g',
    image: 'https://www.waitrose.com/product/images/essential-mature-cheddar',
    price: 3.25,
    unitPrice: '£8.13/kg',
    source: 'catalogue',
  },
  {
    ...
    size: '6 x 25g',
    image: 'https://www.waitrose.com/product/images/walkers-crisps-6-pack',
    price: 2.0,
    unitPrice: '33p/pack',
    source: 'catalogue',
  },
  {
    ...
    size: '6 x 25g',
    image: 'https://www.waitrose.com/product/images/mccoys-crisps',
    price: 2.5,
    unitPrice: '42p/pack',
    source: 'catalogue',
  },
  {
    ...
    size: '400g',
    image: 'https://www.waitrose.com/product/images/no1-sourdough',
    price: 2.75,
    unitPrice: '£6.88/kg',
    source: 'catalogue',
  },
  {
    ...
    size: '500g',
    image: 'https://www.waitrose.com/product/images/kelloggs-cornflakes',
    price: 3.0,
    unitPrice: '£6.00/kg',
    source: 'catalogue',
  },
  {
    ...
    size: '1 litre',
    image: 'https://www.waitrose.com/product/images/essential-orange-juice',
    price: 1.1,
